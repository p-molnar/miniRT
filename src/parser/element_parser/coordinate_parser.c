...
/*   Updated: 2023/07/19 15:18:48 by pmolnar       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_coordinates(t_coord3 *coord, char *input, t_line line_info)
{
	...
	if (get_arr_size(coords) != 3)
		error((t_err){"Wrong coordinate separation/incomplete coordinates: x,y,z", line_info.file, line_info.num, EXIT, 1});
	i = 0;
	while (coords[i])
	{
